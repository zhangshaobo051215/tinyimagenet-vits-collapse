...
def load_train_data(img_size, magnitude, batch_size, data_root='.', num_workers=8):
...
def load_val_data(img_size, batch_size, data_root='.', num_workers=4, max_samples=None):
    data_root = Path(data_root)
    with open(data_root / 'val_dataset.pkl', 'rb') as f:
